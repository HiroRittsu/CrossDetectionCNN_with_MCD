...
class CustomTripleTimeDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        image1 = self.fp_set['image'][index]
        image2 = self.fp_set['image'][index + self.n]
        image3 = self.fp_set['image'][index + self.n + self.n]
        label1 = self.fp_set['label'][index]
        label2 = self.fp_set['label'][index + self.n]
        label3 = self.fp_set['label'][index + self.n + self.n]
